...
export default function InyeonLanding() {
  return (
    <main
      style={{
        minHeight: "100vh",
    ...
    >
      <div style={{ maxWidth: 480, margin: "0 auto" }}>
        ...
        >
          <svg viewBox="0 0 240 200" style={{ position: "absolute", top: -10, left: -20, width: 120, opacity: 0.85, transform: "rotate(-12deg)", pointerEvents: "none", zIndex: 0 }}>
            <path d="M 10,20 C 60,40 100,10 130,50 C 160,90 90,110 130,140 C 170,170 220,140 230,180" fill="none" stroke={THREAD} strokeWidth={2} strokeLinecap="round" opacity={0.85} />
            <circle cx={10} cy={20} r={4} fill={THREAD} />
            <circle cx={230} cy={180} r={3} fill={THREAD} opacity={0.6} />
          </svg>
          <svg viewBox="0 0 240 200" style={{ position: "absolute", bottom: -15, right: -22, width: 140, opacity: 0.85, transform: "rotate(195deg)", pointerEvents: "none", zIndex: 0 }}>
            <path d="M 10,20 C 60,40 100,10 130,50 C 160,90 90,110 130,140 C 170,170 220,140 230,180" fill="none" stroke={THREAD} strokeWidth={2} strokeLinecap="round" opacity={0.85} />
            <circle cx={10} cy={20} r={4} fill={THREAD} />
            <circle cx={230} cy={180} r={3} fill={THREAD} opacity={0.6} />
          </svg>
          ...
          <div style={{ position: "relative", zIndex: 2 }}>
            <div style={{ textAlign: "center", fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", color: GOLD, fontSize: 11, letterSpacing: "0.4em", marginBottom: 16 }}>
              <span style={{ fontFamily: "'Nanum Myeongjo', serif", fontStyle: "normal", color: THREAD, marginRight: 10, letterSpacing: "0.25em" }}>
                傳 說
              </span>
              THE LEGEND
            </div>

            <h1 style={{ fontFamily: "'Nanum Myeongjo', serif", fontWeight: 800, fontSize: 22, lineHeight: 1.45, textAlign: "center", color: INK, marginBottom: 28, letterSpacing: "-0.01em" }}>
              운명의 두 사람은,<br />
              <span style={{ color: THREAD, fontWeight: 800 }}>붉은 실</span>로 묶여 있다.
            </h1>

            <div style={{ fontFamily: "'Gowun Batang', serif", fontSize: 14, lineHeight: 2.05, color: INK, textAlign: "center", marginBottom: 28 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginTop: 28, paddingTop: 24, borderTop: `1px solid ${GOLD_LIGHT}55`, flexWrap: "wrap", marginBottom: 28 }}>
            ...
            <Link href="/inyeon/form" style={{ textDecoration: "none" }}>
              <button
                style={{
                  width: "100%",
                  padding: "16px",
