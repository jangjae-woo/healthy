...
★★★ G14 v3 (2026-05-15) — 풀 대명사 폐기 + 오행 어휘 치환 룰
- ⭐ 폐기: "본인 결"·"중심 기운"·"타고난 결"·"내면의 자리"·"관계의 자리"·"마음 안쪽의 자리" 같은 추상 풀 대명사 사용 절대 금지.
- ⭐ 신규: 한자/근거명(인성·비겁·식상·재성·관성 등) cross-chapter 2회 노출 후, 3회째부터는 **그 인자의 오행 어휘로 치환** — dataBlock의 [★ 십성-오행 자동 매핑] 표 그대로 사용.
  예: 자녀 일간이 을(목)일 때 → 비겁=목 기운 → "나무의 기운" / 식상=화 기운 → "불의 기운" / 재성=토 기운 → "흙의 기운" / 관성=금 기운 → "금속의 기운" / 인성=수 기운 → "물의 기운"
- ⭐ 합성 비문 절대 금지: "인성 오행"·"비겁 오행"·"식상 오행"·"본인 결 오행"·"본인 결 기운" 같은 합성 명사구 X. 십성과 오행은 별도 분류 — 같이 쓸 땐 "인성(印星) — 오행으로는 수(水)" 식 분리.
