...
<!-- D안 G 시나리오 2 (실제 삭제): Ch 1 기운 총량 페이지 본문은 통째 제거됨. 동일 인자(일간 강도)는 Ch 5 첫 페이지 "### 기운 총량 — 자녀의 에너지 결이 일상에 어떻게 흐르나요"가 PRIMARY. -->
...
<!-- D안 G 시나리오 2 (실제 삭제): Ch 1 격국 페이지 본문은 통째 제거됨. 격국 정의·풀이는 Ch 7-1 격국 기반 직업 적성이 단일 PRIMARY. -->
...
<!-- D안 G 시나리오 2 (실제 삭제): Ch 1 일주 캐릭터 페이지 본문은 통째 제거됨. 일주 메타포는 차트 페이지 헤더 자동 표시 + 모든 챕터 톤 참조로 분산. -->
...
<!-- D안 G 시나리오 2 (실제 삭제): Ch 1 타고난 귀인 페이지 본문은 통째 제거됨. 학당·문창은 Ch 3 학습의 결, 복성·천을·도화는 Ch 4-3 인복의 결이 PRIMARY. 태극·천덕·월덕·금여는 정의 X (드문 보조 신살). -->
...
<!-- D안 G 시나리오 2 (실제 삭제): Ch 1 평생 빛나는 결 (용신·기신) 페이지 본문은 통째 제거됨. 용신은 Ch 5-3 개운법, 기신은 Ch 5-5 절대 하면 안 5가지가 PRIMARY. -->
