...
🔴 **예외 — 본질 풀이가 메인 슬롯인 페이지 (사주 풀이 유지)**:
- Ch 1 본질 챕터의 모든 페이지 (격국·일주·귀인·용신/기신·다섯 색깔·기운 총량)
- Ch 2의 "### 다섯 색깔의 결" (PRIMARY 본질 슬롯)
- Ch 6의 "### 자녀 인생 흐름 한눈에" (대운 PRIMARY)
- Ch 7·8의 "### 엄마(아빠)와 자녀의 일지 관계" (mom 측만 PRIMARY 정의), "### 엄마(아빠)가 자녀에게 주는 결 — 부모 십성" (mom 측만 PRIMARY 정의)
- Ch 9의 "### 타고난 재능 영역", "### 격국(格局) 기반 직업 적성"
이 페이지들 *외*의 모든 도메인 챕터 페이지는 위 영역 가이드 톤 강제.
...
본문 구조 (반드시 이 흐름, 240~280자로 압축 — D안 C-A: 본질 챕터는 한눈 요약 톤, 3 단락):
