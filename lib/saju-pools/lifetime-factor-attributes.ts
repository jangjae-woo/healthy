...
export const LIFETIME_FACTOR_ATTRIBUTES: Partial<Record<LifetimeFactorId, Partial<Record<LifetimeSectionId, string>>>> = {
  ...
  관성: {
    ...
    health: "마음이 지치는 패턴 — 책임 부담·기대 부담 (메인 sub: health-2, 관성+인성)",
    hidden: "",
    timeline1: "",
    compass: "",
    love2: "",
    love3: "결혼 후 부부 관계의 책임·체계 결 (보조)",
    timeline2: "",
    closing: "",
  },
  인성: {
    ...
    health: "마음 회복의 받쳐주는 결 (서브, health-2 관성+인성)",
    hidden: "",
    timeline1: "",
    compass: "",
  },
  일간: {
    ...
    health: "",
    hidden: "",
    timeline1: "지금 대운과 상호작용 — 자기 결의 본질 (메인 sub: timeline1-1, 현재 대운+일간)",
    compass: "평생 키워드의 본질 + 마지막 방향 (메인 sub: compass-1, compass-3)",
    love2: "",
    love3: "",
    timeline2: "",
    closing: "마지막 당부 자연 비유 회수 (메인 sub: cl_final_words, 일간 자연 비유)",
  },
  월지: {
  ...
  일지: {
    ...
    timeline1: "",
    compass: "",
    love2: "곁에 두면 좋은 사람·피해야 할 인연 — 일지 결 (메인)",
    love3: "배우자궁 — 배우자 특성·결혼 후 부부 관계 (메인 sub: l3_spouse_trait, l3_marriage_dynamics)",
    timeline2: "",
    closing: "",
  },
  일주: {
  ...
  신살_귀인: {
    ...
    health: "",
    hidden: "내 결을 살리는 안전장치 — 길성 (메인 sub: hidden-4, 월덕·문창·태극·학당귀인)",
    timeline1: "",
    compass: "",
    love2: "",
    love3: "귀인을 만나는 법 — 천을·천덕귀인 등 (메인 sub: l3_gwiin_meeting)",
    timeline2: "",
    closing: "",
  },
  신살_흉: {
    ...
    health: "",
    hidden: "조심해야 할 신살 — 흉살 (메인 sub: hidden-3, 괴강·백호·현침·양인)",
    timeline1: "",
    compass: "",
  },
  신강신약: {
    ...
    health: "피해야 할 과로 방식 — 태강/태약 무리 패턴 (메인 sub: health-4)",
    hidden: "",
    timeline1: "",
    compass: "",
  },
  대운: {
    ...
    health: "",
    hidden: "",
    timeline1: "지금 대운 핵심 + 향후 대운 전환 (메인 sub: timeline1-1, timeline1-3)",
    compass: "",
    love2: "",
    love3: "결혼 인연의 기운이 흐르는 시기 (메인 sub: l3_marriage_timing, 대운+신살)",
    timeline2: "5년 세운(年運) 흐름 — 메인 시간축 (모든 sub 메인)",
    closing: "",
  },
  용신: {
    ...
    health: "회복이 빠른 생활 리듬 — 약처럼 작용하는 기운 (메인 sub: health-3, 용신+12운성)",
    hidden: "",
    timeline1: "",
    compass: "앞으로 잘 풀리는 선택 — 종합 처방 (메인 sub: compass-2)",
  },
  기신: {
    personality1: "",
  ...
  격국: {
    ...
    love1: "",
    health: "",
    hidden: "과해지면 흔들리는 기운 — 격국 변화 (메인 sub: hidden-1, 과다 오행+격국 변화)",
    timeline1: "",
    compass: "평생 가져갈 핵심 키워드 — 본질 (메인 sub: compass-1, 격국+일간)",
  },
  공망: {
    personality1: "",
    personality2: "",
    ...
    love1: "",
    health: "",
    hidden: "운이 막힐 때 나오는 습관 — 빈자리 (메인 sub: hidden-2, 공망+약운성)",
    timeline1: "",
    compass: "",
  },
  충: {
  ...
  과다_오행: {
    ...
    love1: "",
    health: "",
    hidden: "과해지면 흔들리는 기운 (메인 sub: hidden-1)",
    timeline1: "",
    compass: "",
  },
  약한_오행: {
    ...
    love1: "",
    health: "몸이 약해지는 신호 — 오행→몸 부위 (메인 sub: health-1)",
    hidden: "",
    timeline1: "",
    compass: "",
  },
