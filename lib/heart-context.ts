...
const SIX_FACTOR_WEAK_PHRASE: Record<string, Record<AgeStage, string>> = {
  ...
  표현력: {
    infant: "마음·감정을 밖으로 잘 드러내지 않는 편 — 표현이 적은 결입니다. 부모님께서 자녀의 표정·몸짓도 함께 읽어주시고 작은 표현을 인정해주시면 마음이 자연스럽게 펼쳐집니다.",
    preschool: "표현이 더디고 자기 생각·감정을 말로 잘 드러내지 못하는 편입니다. 부모님께서 자녀의 침묵을 기다려주시고 짧은 표현도 격려해주시면 표현력이 자라납니다.",
    elementary: "자기 표현이 약한 편 — 의견을 잘 드러내지 못하고 관찰에 머무는 결입니다. 부모님께서 일상에서 의견을 자연스럽게 묻고 들어주시면 표현이 자라납니다.",
    secondary: "표현이 신중하고 자기 의견을 잘 내놓지 않는 편입니다. 부모님께서 자녀의 의견을 자주 물어주시고 결정에 반영해주시면 표현력이 자라납니다.",
  },
  감수성: {
    infant: "주변 미묘한 변화에 둔감한 편 — 섬세한 자극을 잘 알아차리지 못하는 결입니다. 부모님께서 풍부한 자극(음악·자연·이야기)을 함께 나눠주시면 감수성이 자연스럽게 자라납니다.",
    preschool: "감정·미묘한 결을 잘 알아차리지 못하는 편 — 감수성이 약한 결입니다. 부모님께서 그림책·이야기로 다양한 감정을 함께 짚어주시면 감수성이 자라납니다.",
    elementary: "섬세한 감각이 약한 편 — 미묘한 결을 놓치기 쉽습니다. 부모님께서 음악·예술·자연을 함께 즐기시면 감수성이 자라납니다.",
    secondary: "감수성이 약한 편 — 섬세한 결의 가치를 잘 못 보고 실리·실용에 더 끌립니다. 부모님께서 예술·문학·심리 같은 풍부한 자극을 함께 나눠주시면 감수성이 자라납니다.",
  },
  끈기: {
  ...
  창의성: {
    infant: "창의·새 발상이 약한 편 — 익숙한 방식·반복된 자극에 머무는 결입니다. 부모님께서 같은 놀이도 변형해보시고 작은 새 시도를 격려해주시면, 창의성이 자연스럽게 자라납니다.",
    preschool: "창의·자유로운 발상이 약한 편 — 정해진 틀에서 벗어나기 어려운 결입니다. 부모님께서 정답을 강요하지 않으시고 자녀만의 방식을 인정해주시면, 창의성이 자라납니다.",
    elementary: "창의·새 발상이 약한 편 — 정해진 절차는 잘 따르나 자유로운 발상이 어려운 결입니다. 부모님께서 다양한 시도를 격려해주시면, 창의성이 자라납니다.",
    secondary: "창의력이 약한 편 — 새 기획·시도가 어렵고 정립된 길을 따라가려는 결입니다. 부모님께서 자녀의 자유로운 의견을 자주 물어주시면, 창의성이 자라납니다.",
  },
  자기조절: {
    infant: "충동·욕구가 강한 편 — 자기 페이스 조율이 어려운 결입니다. 부모님께서 일관된 약속·규칙을 함께 지켜주시고 차분한 분위기를 마련해주시면, 자기조절이 자연스럽게 자라납니다.",
    preschool: "차례·기다림이 어려운 편 — 충동이 먼저 움직이는 결입니다. 부모님께서 짧은 기다림부터 함께 연습하고 성공을 인정해주시면, 자기조절이 자라납니다.",
    elementary: "자기 페이스 조율이 어려운 편 — 외부 자극에 쉽게 휘둘리고 충동을 다스리기 어려운 결입니다. 부모님께서 일정·규칙을 함께 짚어주시면, 자기조절이 자라납니다.",
    secondary: "자기 관리·통제가 약한 편 — 충동이 강해 외부 구조가 필요한 결입니다. 부모님께서 일관된 기준·약속을 함께 지켜주시면, 자기조절이 자라납니다.",
  },
};
...
export function buildSixFactorBodyContext(
  ...
  // C-37: 6요인 페이지는 차트가 이미 시각 분리 → 본문은 단일 단락이 자연 (F-2 적합)
