...
[★★★ V2.3.0 결혼운 강조 (2026-05-15)]
"사랑과 가족의 자리" sub는 사실상 "결혼운"입니다. 다음 3축 모두 다루세요:
- 배우자 결의 특징(일지 배우자궁 기준) — 어떤 결의 사람과 잘 맞는지
- 결혼 인연 시기 — 대운에서 정관·정재·식상 자리하는 연령대 (구체 단정 X, "이 시기에 인연이 무르익는 결" 어조)
- 결혼 생활의 결 — 안정적인지 변화 많은지 (재성·관성 균형 + 12운성으로)
본문에 "결혼" 단어를 1~2회 자연스럽게 노출 (강제 표기 X — 풀이 흐름 안에).
