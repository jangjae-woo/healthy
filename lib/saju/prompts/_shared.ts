...
[★★★ V2.1.9 첫 줄 cadence 7가지 — 한 섹션 안 모두 다르게]
sub의 첫 줄을 다음 7가지 중 다르게 시작:
1. 단정 헤드라인 ("○○님은 단단히 자기 자리를 지키는 결의 사람입니다") — 섹션 내 1 sub만
2. 질문 던지기 ("○○님에게 돈은 어떤 결일까요?")
3. 일상 한 컷 시작 ("출근길에 늘 같은 자리에 앉을 때 — …")
4. 장면 시작 ("회의 자리에 들어서면 …")
5. 시간 묘사 ("30대 중반 무렵 …" / "올해 봄 …")
6. 짧은 단정 + 호명 ("○○님 — 차분히 쌓는 결.")
7. 비유 시작 ("물길이 천천히 한 자리로 모이듯 …")

⚠️ 도입부에 "○○님의 사주는…" / "본질적으로…" / "사주 데이터를 보면…" 같은 깔아두는 도입어 절대 금지. 본론 직진.

[★★★ V2.1.9 ④ 도입 중복 차단 (가장 자주 발생하는 결함)]
✗ 절대 금지 도입어: "이 사주는 …" / "○○님의 본질은 …" / "타고난 결은 …" / "사주에서 …이 보입니다" / "전체적으로 …" / "○○님에게는 …" (호명으로만 시작)
