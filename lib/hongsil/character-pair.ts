...
const MATRIX: Record<FemaleCharacter, Record<MaleCharacter, PairLabel>> = {
  옥순: {
    ...
    정수: { label: "직진녀를 다듬어주는 단정한 인연", tone: "솔직한 매력이 반듯한 결을 만나 차분히 자리잡는 사이" },
  },
  현숙: {
    ...
    정수: { label: "도시 모던과 단정함의 인연", tone: "세련된 결이 반듯한 매너를 만나 격조 있는 사이" },
  },
  정숙: {
    ...
    정수: { label: "강단과 단정함의 인연", tone: "성숙한 결과 반듯한 매너가 만나 가장 격조 있는 사이" },
  },
  순자: {
    ...
    정수: { label: "애교와 단정함이 어우러진 인연", tone: "발랄한 매력이 반듯한 결을 풀어주는 사랑스러운 사이" },
  },
  영숙: {
    ...
    정수: { label: "다정함과 단정함의 인연", tone: "참한 결과 반듯한 매너가 만나 가장 평온하고 격조 있는 사이" },
  },
  영자: {
    ...
    정수: { label: "일상과 단정함의 인연", tone: "평범한 결과 반듯한 결이 만나 안정된 일상의 사이" },
  },
};
